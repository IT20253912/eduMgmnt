                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setolschool(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setalschool(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setsclershipschool(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setolindex(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setalindex(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setsclershipindex(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setuniname(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setdegreename(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder='Subject Name' onChange={(event) => { setdegreeclass(event.target.value); }} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
